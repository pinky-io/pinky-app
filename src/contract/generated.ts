// Generated by @wagmi/cli@1.0.0 on 5/14/2023 at 8:17:50 AM
import {
  useContractRead,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link pinkyProtocolABI}__ and `functionName` set to `"isGuardEnabled"`.
 */
export function usePinkyProtocolIsGuardEnabled<
  TFunctionName extends 'isGuardEnabled',
  TSelectData = ReadContractResult<typeof pinkyProtocolABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof pinkyProtocolABI, TFunctionName, TSelectData>,
